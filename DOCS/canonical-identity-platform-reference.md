...
- [Hydra](https://charmhub.io/hydra)
- [Kratos](https://charmhub.io/kratos)
- [Kratos External IdP Integrator](https://charmhub.io/kratos-external-idp-integrator)
- [Identity Platform Login UI](https://charmhub.io/identity-platform-login-ui-operator)
